...
load("../Data/Merged_cohorts_lgRFU_exprset.RData")
exprs <- exprs(Merged_cohorts_lgRFU_exprset)
prot <- fData(Merged_cohorts_lgRFU_exprset)
samp <- pData(Merged_cohorts_lgRFU_exprset)
...
pdf("../Line_plots_win/Lineplots_all_proteins_Detroit.pdf",
      width = 10, height = 10)
...
pdf("../Line_plots_win/Lineplots_all_proteins_Oslo.pdf",
    width = 10, height = 10)
...
pdf("../Line_plots_win/Lineplots_all_proteins_Stanford.pdf",
    width = 10, height = 10)
