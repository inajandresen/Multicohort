...
#All proteins EN
load("../Prediction/Prediction_all_proteins_clinical/Predict_all_proteins_T2EN_clinical.RData")
T2_EN_freq <- freq
T2_EN_pile <- pile
...
#All proteins RF
load("../Prediction/Prediction_all_proteins_clinical/Predict_all_proteins_T2RF_clinical.RData")
T2_RF_freq <- freq
T2_RF_pile <- pile
...
#50 proteins EN
load("../Prediction/Prediction_top50_wilcoxon_clinical/Predict_top50_wilcoxon_T2EN_clinical.RData")
T2_EN_50_freq <- freq
T2_EN_50_pile <- pile
...
#T2_EN_50_auc_txt <- "0.66"
T2_EN_50_ci <- ci(T2_EN_50_RC, of = "auc")
T2_EN_50_ci_txt <- "95% CI: 0.59-0.73"
...
#50 proteins RF
load("../Prediction/Prediction_top50_wilcoxon_clinical/Predict_top50_wilcoxon_T2RF_clinical.RData")
T2_RF_50_freq <- freq
T2_RF_50_pile <- pile
...
#T2_RF_50_auc_auc_txt <- "0.73"
T2_RF_50_ci <- ci(T2_RF_50_RC, of = "auc")
T2_RF_50_ci_txt <- "95% CI: 0.67-0.80"
...
#All proteins EN
load("../Prediction/Prediction_all_proteins_clinical/Predict_all_proteins_T3EN_clinical.RData")
T3_EN_freq <- freq
T3_EN_pile <- pile
...
#All proteins RF
load("../Prediction/Prediction_all_proteins_clinical/Predict_all_proteins_T3RF_clinical.RData")
T3_RF_freq <- freq
T3_RF_pile <- pile
...
#50 proteins EN
load("../Prediction/Prediction_top50_wilcoxon_clinical/Predict_top50_wilcoxon_T3EN_clinical.RData")
T3_EN_50_freq <- freq
T3_EN_50_pile <- pile
...
#T3_EN_50_auc_auc_txt <- "0.74"
T3_EN_50_ci <- ci(T3_EN_50_RC, of = "auc")
T3_EN_50_ci_txt <- "95% CI: 0.68-0.79"
...
#50 proteins RF
load("../Prediction/Prediction_top50_wilcoxon_clinical/Predict_top50_wilcoxon_T3RF_clinical.RData")
T3_RF_50_freq <- freq
T3_RF_50_pile <- pile
...
#T3_RF_50_auc_txt <- "0.77"
T3_RF_50_ci <- ci(T3_RF_50_RC, of = "auc")
T3_RF_50_ci_txt <- "95% CI: 0.72-0.82"
...
#All proteins EN
load("../Prediction/Prediction_all_proteins_clinical/Predict_all_proteins_T4EN_clinical.RData")
T4_EN_freq <- freq
T4_EN_pile <- pile
...
#T4_EN_auc_auc_txt <- "0.77"
T4_EN_ci <- ci(T4_EN_RC, of = "auc")
T4_EN_ci_txt <- "95% CI: 0.72-0.83"
...
#All proteins RF
load("../Prediction/Prediction_all_proteins_clinical/Predict_all_proteins_T4RF_clinical.RData")
T4_RF_freq <- freq
T4_RF_pile <- pile
...
#50 proteins EN
load("../Prediction/Prediction_top50_wilcoxon_clinical/Predict_top50_wilcoxon_T4EN_clinical.RData")
T4_EN_50_freq <- freq
T4_EN_50_pile <- pile
...
#T4_EN_50_auc_txt <- "0.74"
T4_EN_50_ci <- ci(T4_EN_50_RC, of = "auc")
T4_EN_50_ci_txt <- "95% CI: 0.68-0.80"
...
#50 proteins RF
load("../Prediction/Prediction_top50_wilcoxon_clinical/Predict_top50_wilcoxon_T4RF_clinical.RData")
T4_RF_50_freq <- freq
T4_RF_50_pile <- pile
...
T4_RF_50_ci_txt <- "95% CI: 0.76-0.86"
...
ROC_plot_T4 <- ggroc(list("Random Forest (all proteins)" = T4_RF_RC,
  ...
  annotate("text", 
           label= c(paste0('AUC = ', T4_RF_auc, ', ', T4_RF_ci_txt), 
                    paste0('AUC = ', T4_RF_50_auc, ', ', T4_RF_50_ci_txt), 
...
all_plots <- grid.arrange(ROC_plot_T2, ROC_plot_T3, ROC_plot_T4, legend_roc,
                          ...
                          ncol = 4, 
                          widths = c(0.8, 0.8, 0.8, 0.45),
                          #heights = c(1.2, 0.8),
                          heights = c(1.3, 1))



ggsave(filename= "All_roc_box_clinical.png",
       plot = all_plots,
       device = "png",
       path = "../Prediction/",
       width = 30,
